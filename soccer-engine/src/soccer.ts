...
export const goalPosts = [{ y: GAME_SIZE_Y / 4, x: GAME_SIZE_X - 3 }, { y: GAME_SIZE_Y / 4, x: 0 }]
...
export class Ball extends GameObject {
  ...
  pass() {
    ...
    this.movement_speed = { x: PLAYER_MOVEMENT_SPEED_DEFAULT * 4, y: PLAYER_MOVEMENT_SPEED_DEFAULT * 4 };
